...
('Dragón', '2024-02-10', '2025-01-28');

INSERT INTO `usuario` (`nombre`, `username`, `email`, `fecha_nacimiento`, `password`, `animal`) VALUES
('Juan Pérez', 'juanito', 'juan.perez@example.com', '1990-04-05', 'securePass123', 'Caballo'),
('María López', 'maria89', 'maria.lopez@example.com', '1995-05-15', 'password123', 'Cerdo'),
('Carlos Ruiz', 'carlos_rz', 'carlos.ruiz@example.com', '1988-06-11', 'qwerty123', 'Conejo'),
('Ana Gómez', 'anita_g', 'ana.gomez@example.com', '1992-07-09', '123abc', 'Mono'),
('Luis Martínez', 'luism', 'luis.martinez@example.com', '1985-08-19', 'luisPass1984', 'Buey'),
('Sofía Vargas', 'sofia_v', 'sofia.vargas@example.com', '1997-09-18', 'sofiapass123', 'Cabra'),
('Pablo Torres', 'pablot', 'pablo.torres@example.com', '2001-10-10', 'pablopass', 'Serpiente'),
('Elena Navarro', 'elenan', 'elena.navarro@example.com', '1993-11-15', 'elenapass', 'Dragon'),
('Ricardo Díaz', 'ricardod', 'ricardo.diaz@example.com', '1980-12-10', 'ricardopass', 'Mono'),
('Marta Jiménez', 'martaj', 'marta.jimenez@example.com', '1984-01-10', 'martapass', 'Rata'),
('Daniel Vega', 'danielv', 'daniel.vega@example.com', '1999-02-05', 'danielpass', 'Conejo'),
('Lucía Romero', 'luciar', 'lucia.romero@example.com', '1998-03-15', 'luciapass', 'Tigre');
